...
const JobdeskPersonal = () => {
  ...
  const [nilaiPersonal, setNilaiPersonal] = useState<number | undefined>();
  ...
  const HandleDialog = (id: number, item: any) => {
    openModal("jobdesk-personal");
    setId(id);
    setNilaiPersonal(item?.personal_grade);
  };
  ...
  return (
    <div className="w-full">
      ...
      {/* Modal Update Nilai */}
      <Modal id="jobdesk-personal" width="w-11/12 max-w-5xl">
        <div className="w-full flex flex-col items-center">
          <p className="text-xl font-bold">Update Nilai Personal</p>

          <Input
            label="Nilai"
            value={nilaiPersonal}
            onChange={(e) => setNilaiPersonal(parseInt(e.target.value))}
            type="number"
          />
          ...
          <div className="flex gap-2 mt-4">
            ...
            <button
              ...
              onClick={() => closeModal("jobdesk-personal")}
            >
              Close
            </button>
          </div>
...
export default JobdeskPersonal;
